...
while(dec_num!=1) 
{ 
    binary[k] = dec_num % 2; dec_num /= 2; k++;
}
     binary[k] = 1;
...
while(bin_num != 0) {
decimal += (bin_num % 10) * pow(2, k); bin_num /= 10; k++;
}
cout << decimal << endl;
}
...
while(octal != 0) {
decimal += (octal % 10) * pow(8, k); octal /= 10; k++;
}
cout << decimal << endl;
}
...
while(decimal!=1) { binary[k] = decimal % 2; decimal /= 2; k++;
}
binary[k] = 1;
...
while(octal != 0) {
decimal += (octal % 10) * pow(8, k); octal /= 10;
k++;
} k=0;
while(decimal > 16) { x[k] = decimal % 16; decimal /= 16; k++;
}
x[k] = decimal;
...
k=0;
while(decimal!=1) { 
    binary[k] = decimal % 2; decimal /= 2; k++;
}
binary[k] = 1;
